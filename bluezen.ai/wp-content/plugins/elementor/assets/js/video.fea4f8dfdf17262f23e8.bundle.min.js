    ...
    5363: (e, t) => {
      ...
      class Video extends elementorModules.frontend.handlers.Base {
        ...
        prepareYTVideo(e, t) {
          const i = this.getElementSettings(),
            o = {
              ...
              events: {
                onReady: () => {
                  i.mute && this.youtubePlayer.mute(),
                    (i.autoplay || t) && this.youtubePlayer.playVideo();
                },
                onStateChange: (t) => {
        ...
        onElementChange(e) {
          ...
          "lightbox" !== e || t || this.hideLightbox();
        }
      }
      t.default = Video;
    },
