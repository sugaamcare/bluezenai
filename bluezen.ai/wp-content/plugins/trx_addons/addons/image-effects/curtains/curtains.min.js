...
function Curtains(t) {
  ...
  (this._imageCache = []),
  (this._drawStacks = {
    opaque: { length: 0, programs: [], order: [] },
    transparent: { length: 0, programs: [], order: [] },
    renderPasses: [],
    scenePasses: [],
  }),
  ...
  "string" == typeof t) &&
    (console.warn(
      "Since v4.0 you should use an object to pass your container and other parameters. Please refer to the docs: https://www.curtainsjs.com/documentation.html"
    ),
    (t = { container: (e = t) }));
  t.container
    ? "string" == typeof t.container
      ? (this.container = document.getElementById(t.container))
      : t.container instanceof Element && (this.container = t.container)
    : ((e = document.createElement("div")).setAttribute(
      ...
      (this.container = e));
  if (
    ((this._autoResize = t.autoResize),
    (null !== this._autoResize && void 0 !== this._autoResize) ||
      (this._autoResize = !0),
    (this._autoRender = t.autoRender),
    (null !== this._autoRender && void 0 !== this._autoRender) ||
      (this._autoRender = !0),
    (this._watchScroll = t.watchScroll),
    (null !== this._watchScroll && void 0 !== this._watchScroll) ||
      (this._watchScroll = !0),
    (this.pixelRatio = t.pixelRatio || window.devicePixelRatio || 1),
    (t.renderingScale = isNaN(t.renderingScale)
      ? 1
      : parseFloat(t.renderingScale)),
    (this._renderingScale = Math.max(0.25, Math.min(1, t.renderingScale))),
    (this.premultipliedAlpha = t.premultipliedAlpha || !1),
    (this.alpha = t.alpha),
    (null !== this.alpha && void 0 !== this.alpha) || (this.alpha = !0),
    (this.antialias = t.antialias),
    (null !== this.antialias && void 0 !== this.antialias) ||
      (this.antialias = !0),
    (this.productionMode = t.production || !1),
    !this.container)
  )
    return (
      this.productionMode ||
...
(Curtains.prototype._init = function () {
  ...
  if (
    ((this.gl = this.glCanvas.getContext("webgl2", t)),
    (this._isWebGL2 = !!this.gl),
    this.gl ||
      (this.gl =
        this.glCanvas.getContext("webgl", t) ||
        this.glCanvas.getContext("experimental-webgl", t)),
    !this.gl)
  )
    return (
      this.productionMode || console.warn("WebGL context could not be created"),
      void (this._onErrorCallback && this._onErrorCallback())
    );
  this._getExtensions(),
    (this._glState = {
    ...
    this._watchScroll &&
      window.addEventListener("scroll", this._scrollManager.handler, {
        passive: !0,
      }),
  ...
  (Curtains.prototype._getExtensions = function () {
    (this._extensions = []),
      this._isWebGL2
        ? ((this._extensions.EXT_color_buffer_float = this.gl.getExtension(
            "EXT_color_buffer_float"
          )),
          (this._extensions.OES_texture_float_linear = this.gl.getExtension(
            "OES_texture_float_linear"
          )),
          (this._extensions.WEBGL_lose_context =
            this.gl.getExtension("WEBGL_lose_context")))
        : ((this._extensions.OES_vertex_array_object = this.gl.getExtension(
          ...
          (this._extensions.OES_texture_half_float = this.gl.getExtension(
            "OES_texture_half_float"
          )),
          (this._extensions.OES_texture_half_float_linear =
            this.gl.getExtension("OES_texture_half_float_linear")),
          (this._extensions.OES_element_index_uint = this.gl.getExtension(
            "OES_element_index_uint"
          )),
          (this._extensions.OES_standard_derivatives = this.gl.getExtension(
            "OES_standard_derivatives"
          )),
          (this._extensions.EXT_sRGB = this.gl.getExtension("EXT_sRGB")),
          (this._extensions.WEBGL_depth_texture = this.gl.getExtension(
            "WEBGL_depth_texture"
          )),
  ...
  (Curtains.prototype._setSize = function () {
    ...
    if (e && i) {
      this._boundingRect.top =
        (function (t) {
          for (var e = 0; t && !isNaN(t.offsetTop); )
    ...
    (this.glCanvas.style.width =
      ...
      (this.glCanvas.width = Math.floor(
        this._boundingRect.width * this._renderingScale
      )),
      (this.glCanvas.height = Math.floor(
  ...
  (Curtains.prototype.resize = function (t) {
    ...
    for (var e = 0; e < this.planes.length; e++)
      this.planes[e]._canDraw && this.planes[e].planeResize();
    for (e = 0; e < this.shaderPasses.length; e++)
      this.shaderPasses[e]._canDraw && this.shaderPasses[e].planeResize();
    for (e = 0; e < this.renderTargets.length; e++)
  ...
  (Curtains.prototype._scroll = function () {
    var t = { x: window.pageXOffset, y: window.pageYOffset };
    if ((this.updateScrollValues(t.x, t.y), this._scrollManager.shouldWatch)) {
      for (var e = 0; e < this.planes.length; e++)
        this.planes[e].watchScroll && this.planes[e].updateScrollPosition();
      this.needRender();
    }
  ...
  (Curtains.prototype.updateScrollValues = function (t, e) {
    ...
    (this._scrollManager.xOffset = t),
      (this._scrollManager.lastXDelta = i - this._scrollManager.xOffset);
    var s = this._scrollManager.yOffset;
    (this._scrollManager.yOffset = e),
      (this._scrollManager.lastYDelta = s - this._scrollManager.yOffset);
  }),
  ...
  (Curtains.prototype.restoreContext = function () {
    this.gl && this._extensions.WEBGL_lose_context
  ...
  (Curtains.prototype._contextRestored = function () {
    ...
    (this._drawingEnabled = !1),
      ...
      (this._imageCache = []);
    for (var e = 0; e < this.renderTargets.length; e++)
    ...
    this._onContextRestoredCallback && this._onContextRestoredCallback(),
      (this._drawingEnabled = t),
      this.needRender(),
      this._autoRender && this._animate();
  }),
  (Curtains.prototype.dispose = function () {
    for (this._isDestroying = !0; this.planes.length > 0; )
    ...
    var i = this,
      s = setInterval(function () {
        0 === i.planes.length &&
          0 === i.shaderPasses.length &&
          0 === i.renderTargets.length &&
          (clearInterval(s),
          i._clear(),
          i._animationFrameID &&
            window.cancelAnimationFrame(i._animationFrameID),
          this._resizeHandler &&
            window.removeEventListener("resize", i._resizeHandler, !1),
          this._watchScroll &&
            window.removeEventListener("scroll", this._scrollManager.handler, {
              passive: !0,
            }),
          i.glCanvas.removeEventListener(
            "webgllost",
            i._contextLostHandler,
            !1
          ),
          i.glCanvas.removeEventListener(
            "webglrestored",
            i._contextRestoredHandler,
            !1
          ),
          i.gl &&
            i._extensions.WEBGL_lose_context &&
            i._extensions.WEBGL_lose_context.loseContext(),
          (i.glCanvas.width = i.glCanvas.width),
          (i.gl = null),
          i.container.removeChild(i.glCanvas),
          (i.container = null),
          (i.glCanvas = null));
      }, 100);
  }),
    ...
    if (
      ...
      for (
        var s =
          ...
          r = this.gl.getShaderSource(i).split("\n"),
          a = 0;
        a < r.length;
        a++
      )
      ...
      return (
        (r = r.join("\n")),
        console.warn(
          "Errors occurred while compiling the",
          s,
          ":\n",
  ...
  (Curtains.prototype._setupProgram = function (t, e, i) {
    for (var s = {}, r = 0; r < this._glState.programs.length; r++)
      if (
        this._isEqualShader(this._glState.programs[r].vsCode, t) &&
        this._isEqualShader(this._glState.programs[r].fsCode, e)
      ) {
  ...
  (Curtains.prototype._useExistingShaders = function (t) {
    return {
      vs: { vertexShader: t.vertexShader, vsCode: t.vsCode },
      fs: { fragmentShader: t.fragmentShader, fsCode: t.fsCode },
    };
  }),
  (Curtains.prototype._useNewShaders = function (t, e) {
    ...
    return (
      ...
      i
        ? {
            vs: { vertexShader: s, vsCode: t },
            fs: { fragmentShader: r, fsCode: e },
          }
        : i
    );
  }),
  (Curtains.prototype._createProgram = function (t, e) {
    ...
    if (
      (s &&
        (i.attachShader(r, t.vs.vertexShader),
        i.attachShader(r, t.fs.fragmentShader),
        i.linkProgram(r),
        this.productionMode ||
          i.getProgramParameter(r, i.LINK_STATUS) ||
          (console.warn("Unable to initialize the shader program."), (s = !1)),
        i.deleteShader(t.vs.vertexShader),
        i.deleteShader(t.fs.fragmentShader)),
      s)
    ) {
      var a = {
      ...
      return (
        "Plane" === e &&
          ((this._drawStacks.opaque.programs["program-" + a.id] = []),
          (this._drawStacks.transparent.programs["program-" + a.id] = [])),
        this._glState.programs.push(a),
        a
      );
    }
    return s;
  ...
  (Curtains.prototype._useProgram = function (t) {
    (null !== this._glState.currentProgramID &&
      this._glState.currentProgramID === t.id) ||
  ...
  (Curtains.prototype.removePlane = function (t) {
    ...
    for (var s = 0; s < this.planes.length; s++)
      t.uuid === this.planes[s].uuid && (e = s);
    (t = null), (this.planes[e] = null), this.planes.splice(e, 1);
    for (s = 0; s < this._glState.programs.length; s++)
      (this._drawStacks.opaque.programs[
        "program-" + this._glState.programs[s].id
      ] = []),
        (this._drawStacks.transparent.programs[
          "program-" + this._glState.programs[s].id
        ] = []);
    ...
    for (s = 0; s < this.planes.length; s++) {
      ...
      "transparent" === r
        ? this._drawStacks[r].programs["program-" + t._usedProgram.id].unshift(
            t.index
          )
        : this._drawStacks[r].programs["program-" + t._usedProgram.id].push(
            t.index
          ),
        this._drawStacks[r].length++;
    }
    for (s = 0; s < this._drawStacks[i].order.length; s++) {
      var a = this._drawStacks[i].order[s];
      0 === this._drawStacks[i].programs["program-" + a].length &&
        this._drawStacks[i].order.splice(s, 1);
    }
  ...
  (Curtains.prototype._stackPlane = function (t) {
    ...
    "transparent" === e
      ? (i.programs["program-" + t._usedProgram.id].unshift(t.index),
        i.order.includes(t._usedProgram.id) ||
          i.order.unshift(t._usedProgram.id))
      : (i.programs["program-" + t._usedProgram.id].push(t.index),
        i.order.includes(t._usedProgram.id) || i.order.push(t._usedProgram.id)),
      i.length++;
  }),
  (Curtains.prototype.addRenderTarget = function (t) {
    return this.gl
      ? new Curtains.RenderTarget(this, t)
      : (this.productionMode ||
          console.warn(
            "Unable to create a render target. The WebGl context couldn't be created"
          ),
        this._onErrorCallback && this._onErrorCallback(),
        null);
  }),
  (Curtains.prototype.removeRenderTarget = function (t) {
    if (t._shaderPass)
      this.productionMode ||
        console.warn(
          "You're trying to remove a render target attached to a shader pass. You should remove that shader pass instead:",
          t._shaderPass
        );
    else {
      for (var e = 0; e < this.planes.length; e++)
      ...
      var i;
      for (e = 0; e < this.renderTargets.length; e++)
        t.uuid === this.renderTargets[e].uuid && (i = e);
      (this.renderTargets[i] = null),
        this.renderTargets.splice(i, 1),
        t && t._dispose(),
        (t = null),
        this.gl && this._clear(),
  ...
  (Curtains.prototype.addShaderPass = function (t) {
    if (this.gl) {
      ...
      return (
        e._usedProgram
          ? (t.renderTarget
              ? this._drawStacks.renderPasses.push(e.index)
              : this._drawStacks.scenePasses.push(e.index),
            this.shaderPasses.push(e))
          : (e = !1),
        e
      );
    }
    return (
      this.productionMode ||
        console.warn(
          "Unable to create a shader pass. The WebGl context couldn't be created"
        ),
      this._onErrorCallback && this._onErrorCallback(),
      null
    );
  ...
  (Curtains.prototype._bindFrameBuffer = function (t, e) {
    ...
    t
      ...
      (this._glState.frameBufferID = i);
  }),
  (Curtains.prototype._setDepth = function (t) {
    t && !this._glState.depthTest
      ? ((this._glState.depthTest = t), this.gl.enable(this.gl.DEPTH_TEST))
      : !t &&
        this._glState.depthTest &&
        ((this._glState.depthTest = t), this.gl.disable(this.gl.DEPTH_TEST));
  }),
  ...
  (Curtains.prototype._multiplyMatrix = function (t, e) {
    ...
    return (
      (i[0] = e[0] * t[0] + e[1] * t[4] + e[2] * t[8] + e[3] * t[12]),
  ...
  (Curtains.prototype._composeMatrixFromOrigin = function (t, e, i, s) {
    ...
    return (
      ...
      (r[10] = L),
      (r[11] = 0),
      (r[12] = t.x + C - (w * C + E * T + F * S)),
      (r[13] = t.y + T - (R * C + B * T + A * S)),
      (r[14] = t.z + S - (M * C + D * T + L * S)),
      (r[15] = 1),
      r
    );
  }),
  (Curtains.prototype._applyMatrixToPoint = function (t, e) {
    var i = [],
      ...
      r = t[1],
      a = t[2];
    (i[0] = e[0] * s + e[4] * r + e[8] * a + e[12]),
      (i[1] = e[1] * s + e[5] * r + e[9] * a + e[13]),
      (i[2] = e[2] * s + e[6] * r + e[10] * a + e[14]);
  ...
  (Curtains.prototype._drawPlaneStack = function (t) {
    for (var e = 0; e < this._drawStacks[t].order.length; e++)
      for (
        var i = this._drawStacks[t].order[e],
          s = this._drawStacks[t].programs["program-" + i],
          r = 0;
        r < s.length;
        r++
      ) {
  ...
  (Curtains.prototype.render = function () {
    if (this._drawingEnabled || this._forceRender) {
      this._forceRender && (this._forceRender = !1),
        ...
        this._clear(),
        this._drawStacks.scenePasses.length > 0 &&
          0 === this._drawStacks.renderPasses.length &&
          ((this._glState.scenePassIndex = 0),
          this._bindFrameBuffer(
            this.shaderPasses[this._drawStacks.scenePasses[0]].target
          )),
        this._drawPlaneStack("opaque"),
        this._drawStacks.transparent.length &&
          (this.gl.clearDepth(1),
          this.gl.clear(this.gl.DEPTH_BUFFER_BIT),
          this._drawPlaneStack("transparent")),
        this._drawStacks.scenePasses.length > 0 &&
          this._drawStacks.renderPasses.length > 0 &&
          ((this._glState.scenePassIndex = 0),
          this._bindFrameBuffer(
            this.shaderPasses[this._drawStacks.scenePasses[0]].target
          ));
  ...
  (Curtains.BasePlane = function (t, e, i) {
    (this._type = this._type || "BasicPlane"),
      ...
      this._initBasePlane(i);
  }),
  (Curtains.BasePlane.prototype._initBasePlane = function (t) {
    if (
      (t || (t = {}),
      (this._canDraw = !1),
      (this.shareProgram = t.shareProgram || !1),
      (this._updatePerspectiveMatrix = !1),
      (this._updateMVMatrix = !1),
      (this._definition = {
        width: parseInt(t.widthSegments) || 1,
        height: parseInt(t.heightSegments) || 1,
      }),
      (this._definition.buffersID =
        this._definition.width * this._definition.height +
        this._definition.width),
      (this._depthTest = t.depthTest),
      (null !== this._depthTest && void 0 !== this._depthTest) ||
        (this._depthTest = !0),
      (this.cullFace = t.cullFace),
      "back" !== this.cullFace &&
        "front" !== this.cullFace &&
        "none" !== this.cullFace &&
        (this.cullFace = "back"),
    ...
    return (
      (this._usedProgram = this._curtains._setupProgram(
        s.vertexShaderCode,
    ...
    return (
      ...
      t.fragmentShader ||
        (r && document.getElementById(r)
          ? (i = document.getElementById(r).innerHTML)
          : (this._curtains.productionMode ||
              console.warn(
                "No fragment shader provided, will use a default one"
              ),
            (i = this._getDefaultFS()))),
      {
  ...
  (Curtains.BasePlane.prototype._setUniforms = function () {
    ...
    if (this.uniforms)
      for (var a in this.uniforms) {
        ...
        (n.location = e.getUniformLocation(this._usedProgram.program, n.name)),
          n.type ||
          ...
          this._handleUniformSetting(n.type, n.location, n.value);
      }
  }),
  (Curtains.BasePlane.prototype._updateUniforms = function () {
    if (this.uniforms)
      for (var t in this.uniforms) {
        ...
        this.shareProgram
          ? this._handleUniformSetting(e.type, e.location, e.value)
          : (e.value.length || e.value === e.lastValue
  ...
  (Curtains.BasePlane.prototype._setAttributes = function () {
    this._attributes || (this._attributes = {}),
      (this._attributes.vertexPosition = {
        ...
        location: this._curtains.gl.getAttribLocation(
          this._usedProgram.program,
          "aVertexPosition"
        ),
      }),
  ...
  (Curtains.BasePlane.prototype._initializeBuffers = function () {
    ...
    this._geometry || this._material || this._setPlaneVertices(),
      this._attributes &&
        ...
        this._curtains._isWebGL2
          ? ((this._vao = t.createVertexArray()), t.bindVertexArray(this._vao))
          : this._curtains._extensions.OES_vertex_array_object &&
            ((this._vao =
              this._curtains._extensions.OES_vertex_array_object.createVertexArrayOES()),
            this._curtains._extensions.OES_vertex_array_object.bindVertexArrayOES(
              this._vao
            )),
        ...
        (this._curtains._glState.currentBuffersID =
          this._definition.buffersID));
  }),
  (Curtains.BasePlane.prototype._restoreContext = function () {
    ...
    if (
      ...
      (this._usedProgram = t._setupProgram(
        this._usedProgram.vsCode,
        this._usedProgram.fsCode,
        this
      )),
      this._usedProgram)
    ) {
      if (
        ...
        this._setUniforms(),
        this._initializeBuffers(),
        "ShaderPass" === this._type)
      )
        if (this._isScenePass)
          (this.target._frameBuffer = null),
            (this.target._depthBuffer = null),
            t.renderTargets.splice(this.target.index, 1),
            this.textures.splice(0, 1),
            this._createFrameBuffer(),
            t._drawStacks.scenePasses.push(this.index);
        else {
          var e = t.renderTargets[this.target.index];
          this.setRenderTarget(e),
            (this.target._shaderPass = e),
            (this.textures[0]._canDraw = !1),
            this.textures[0]._setTextureUniforms(),
            this.textures[0].setFromTexture(e.textures[0]),
            t._drawStacks.renderPasses.push(this.index);
        }
      else
        this.target && this.setRenderTarget(t.renderTargets[this.target.index]);
      for (
        var i = "ShaderPass" === this._type ? 1 : 0;
  ...
  (Curtains.BasePlane.prototype._setDocumentSizes = function () {
    ...
    0 === t.width && 0 === t.height && (t = this._curtains._boundingRect),
  ...
  (Curtains.BasePlane.prototype._getNearPlaneIntersections = function (
    t,
    e,
    i
  ) {
    function s(t, e) {
      for (
        var i = [e[0] - t[0], e[1] - t[1], e[2] - t[2]], s = t.slice();
        s[2] > -1;
    ...
    if (1 === i.length)
      0 === i[0]
        ? ((e[0] = s(
            e[1],
            this._curtains._applyMatrixToPoint(
              [0.95, 1, 0],
              this._matrices.mVPMatrix
            )
          )),
          e.push(
            s(
  ...
  (Curtains.BasePlane.prototype._getWorldCoords = function () {
    for (
      ...
      var r = this._curtains._applyMatrixToPoint(
        t[s],
        this._matrices.mVPMatrix
      );
    ...
    return { top: h, right: n, bottom: o, left: a };
  }),
    ...
    if (this._matrices.mVPMatrix) {
      ...
      return (
        ...
        (e.height = e.bottom - e.top),
        {
          ...
          top:
            e.top * this._curtains._boundingRect.height +
            this._curtains._boundingRect.top,
          left:
            e.left * this._curtains._boundingRect.width +
            this._curtains._boundingRect.left,
          right:
            e.left * this._curtains._boundingRect.width +
            this._curtains._boundingRect.left +
            e.width * this._curtains._boundingRect.width,
          bottom:
            e.top * this._curtains._boundingRect.height +
            this._curtains._boundingRect.top +
  ...
  (Curtains.BasePlane.prototype.createTexture = function (t) {
    "string" == typeof t &&
      ...
      this._curtains.productionMode ||
        console.warn(
          "Since v5.1 you should use an object to pass your sampler name with the createTexture() method. Please refer to the docs: https://www.curtainsjs.com/documentation.html (texture concerned: ",
          t.sampler,
          ")"
        )),
      t || (t = {});
  ...
  (Curtains.BasePlane.prototype._isPlaneReady = function () {
    if (
      !this._loadingManager.complete &&
      this._loadingManager.sourcesLoaded >=
  ...
  (Curtains.BasePlane.prototype.loadImage = function (t) {
    ...
    if (i)
      return (
        this.createTexture({ sampler: e.sampler, fromTexture: i }),
        this.images.push(i.source),
        void this._isPlaneReady()
      );
    var s = this.createTexture({ sampler: e.sampler });
    if (((s._onSourceLoadedHandler = s._onSourceLoaded.bind(s, e)), e.complete))
      s._onSourceLoaded(e);
    else if (e.decode) {
      var r = this;
      e.decode()
        .then(s._onSourceLoadedHandler)
        .catch(function () {
          e.addEventListener("load", s._onSourceLoadedHandler, !1),
            e.addEventListener("error", r._sourceLoadError.bind(r, e), !1);
        });
    } else
      e.addEventListener("load", s._onSourceLoadedHandler, !1),
        e.addEventListener("error", this._sourceLoadError.bind(this, e), !1);
    this.images.push(e);
  }),
  (Curtains.BasePlane.prototype.loadVideo = function (t) {
    ...
    (e.preload = !0),
      ...
      (e.sampler = t.getAttribute("data-sampler") || null),
      (e.crossOrigin = this.crossOrigin || "anonymous");
    var i = this.createTexture({ sampler: e.sampler });
  ...
  (Curtains.BasePlane.prototype.mouseToPlaneCoords = function (t, e) {
    var i = this.scale ? this.scale : { x: 1, y: 1 },
      s =
        (this._boundingRect.document.width -
          this._boundingRect.document.width * i.x) /
        2,
      r =
        (this._boundingRect.document.height -
          this._boundingRect.document.height * i.y) /
        2,
      a = (this._boundingRect.document.width * i.x) / this._curtains.pixelRatio,
      n =
        (this._boundingRect.document.height * i.y) / this._curtains.pixelRatio,
      o = (this._boundingRect.document.top + r) / this._curtains.pixelRatio;
    return {
      x:
        ((t -
          (this._boundingRect.document.left + s) / this._curtains.pixelRatio) /
          a) *
          2 -
        1,
      y: 1 - ((e - o) / n) * 2,
  ...
  (Curtains.BasePlane.prototype._bindPlaneBuffers = function () {
    ...
    this._vao
      ? t._isWebGL2
        ? t.gl.bindVertexArray(this._vao)
        : t._extensions.OES_vertex_array_object.bindVertexArrayOES(this._vao)
      : (e.enableVertexAttribArray(this._attributes.vertexPosition.location),
        e.bindBuffer(e.ARRAY_BUFFER, this._geometry.bufferInfos.id),
        ...
        e.enableVertexAttribArray(this._attributes.textureCoord.location),
        e.bindBuffer(e.ARRAY_BUFFER, this._material.bufferInfos.id),
        e.vertexAttribPointer(
          this._attributes.textureCoord.location,
          this._material.bufferInfos.itemSize,
          e.FLOAT,
      ...
      (t._glState.currentBuffersID = this._definition.buffersID);
  }),
  ...
  (Curtains.BasePlane.prototype.setRenderTarget = function (t) {
    t && t._type && "RenderTarget" === t._type
      ? (this.target = t)
      : this._curtains.productionMode ||
        console.warn(
  ...
  (Curtains.BasePlane.prototype._drawPlane = function () {
    ...
    if (
      ...
      "ShaderPass" === this._type
        ? this._isScenePass
          ? t._glState.scenePassIndex + 1 < t._drawStacks.scenePasses.length
            ? (t._bindFrameBuffer(
                t.shaderPasses[
                  t._drawStacks.scenePasses[t._glState.scenePassIndex + 1]
                ].target
              ),
              t._glState.scenePassIndex++)
            : t._bindFrameBuffer(null)
          : null === t._glState.scenePassIndex && t._bindFrameBuffer(null)
        : (this.target
            ? t._bindFrameBuffer(this.target)
            : null === t._glState.scenePassIndex && t._bindFrameBuffer(null),
          this._setPerspectiveMatrix(),
          this._setMVMatrix()),
      (this.alwaysDraw || this._shouldDraw) && this.visible)
    ) {
      t._setDepth(this._depthTest),
        t._setFaceCulling(this.cullFace),
        t._useProgram(this._usedProgram),
      ...
      e.drawArrays(e.TRIANGLES, 0, this._geometry.bufferInfos.numberOfItems),
  ...
  (Curtains.BasePlane.prototype._dispose = function () {
    ...
    if (t) {
      this._vao &&
        (this._curtains._isWebGL2
          ? t.deleteVertexArray(this._vao)
          : this._curtains._extensions.OES_vertex_array_object.deleteVertexArrayOES(
              this._vao
            )),
        this._geometry &&
          (t.bindBuffer(t.ARRAY_BUFFER, this._geometry.bufferInfos.id),
  ...
  (Curtains.Plane = function (t, e, i) {
    (this._type = "Plane"),
      Curtains.BasePlane.call(this, t, e, i),
      (this.index = this._curtains.planes.length),
      (this._canDraw = !1),
      (this.target = null),
      i || (i = {}),
      this._setInitParams(i),
      this._usedProgram
        ? (this._curtains._stackPlane(this),
          this._initPositions(),
          this._initSources())
        : this._curtains._onErrorCallback && this._curtains._onErrorCallback();
  }),
  (Curtains.Plane.prototype = Object.create(Curtains.BasePlane.prototype)),
  (Curtains.Plane.prototype.constructor = Curtains.Plane),
  (Curtains.Plane.prototype._setInitParams = function (t) {
    (this.alwaysDraw = t.alwaysDraw || !1),
      (this._transparent = t.transparent || !1);
    var e = { top: 0, right: 0, bottom: 0, left: 0 };
    t.drawCheckMargins && (e = t.drawCheckMargins),
      (this.drawCheckMargins = e),
      ...
      (this._nearPlane = 0.1),
      (this._farPlane = 150),
      null === t.watchScroll || void 0 === t.watchScroll
        ? (this.watchScroll = this._curtains._watchScroll)
        : (this.watchScroll = t.watchScroll || !1),
      this.watchScroll && (this._curtains._scrollManager.shouldWatch = !0);
  }),
  (Curtains.Plane.prototype._initTransformValues = function () {
    (this.rotation = { x: 0, y: 0, z: 0 }),
      (this.quaternion = new Float32Array([0, 0, 0, 1])),
      (this.relativeTranslation = { x: 0, y: 0, z: 0 }),
      (this._translation = { x: 0, y: 0, z: 0 }),
      (this.scale = { x: 1, y: 1 }),
      (this.transformOrigin = { x: 0.5, y: 0.5, z: 0 });
  }),
  ...
  (Curtains.Plane.prototype._initSources = function () {
    if (this.autoloadSources) {
      for (
        var t = [], e = 0;
        e < this.htmlElement.getElementsByTagName("img").length;
        e++
      )
        t.push(this.htmlElement.getElementsByTagName("img")[e]);
      t.length > 0 && this.loadSources(t);
      var i = [];
      for (
        e = 0;
        e < this.htmlElement.getElementsByTagName("video").length;
        e++
      )
        i.push(this.htmlElement.getElementsByTagName("video")[e]);
      i.length > 0 && this.loadSources(i);
      var s = [];
      for (
        e = 0;
        e < this.htmlElement.getElementsByTagName("canvas").length;
        e++
      )
        s.push(this.htmlElement.getElementsByTagName("canvas")[e]);
      s.length > 0 && this.loadSources(s),
        (this._loadingManager.initSourcesToLoad =
          t.length + i.length + s.length);
    }
  ...
  (Curtains.Plane.prototype._setWorldSizes = function () {
    ...
    (this._boundingRect.world = {
      ...
      (this._boundingRect.world.scale = {
        x:
          ((this._curtains._boundingRect.width /
  ...
  (Curtains.Plane.prototype._setPerspectiveMatrix = function () {
    if (this._updatePerspectiveMatrix) {
      var t =
          this._curtains._boundingRect.width /
          this._curtains._boundingRect.height,
        e = this._nearPlane * Math.tan((Math.PI / 180) * 0.5 * this._fov),
        i = 2 * e,
        s = t * i,
        r = -0.5 * s,
        a = r + s,
        ...
        l = (e + n) / (e - n),
        _ =
          -(this._farPlane + this._nearPlane) /
          (this._farPlane - this._nearPlane),
        c =
          (-2 * this._farPlane * this._nearPlane) /
          (this._farPlane - this._nearPlane);
    ...
    (this.shareProgram ||
      (!this.shareProgram && this._updatePerspectiveMatrix)) &&
      (this._curtains._useProgram(this._usedProgram),
      this._curtains.gl.uniformMatrix4fv(
  ...
  (Curtains.Plane.prototype.setPerspective = function (t, e, i) {
    ...
    (s = Math.max(1, Math.min(s, 179))) !== this._fov && (this._fov = s),
      (this._cameraZPosition = 2 * Math.tan((Math.PI / 180) * 0.5 * this._fov)),
      (this._CSSPerspective =
        Math.pow(
          Math.pow(
            this._curtains._boundingRect.width /
              (2 * this._curtains.pixelRatio),
            2
          ) +
            Math.pow(
              this._curtains._boundingRect.height /
          ...
          0.5
        ) / Math.tan(((this._fov / 2) * Math.PI) / 180)),
      (this._nearPlane = isNaN(e) ? this._nearPlane : parseFloat(e)),
      (this._nearPlane = Math.max(this._nearPlane, 0.01)),
      (this._farPlane = isNaN(i) ? this._farPlane : parseFloat(i)),
      (this._farPlane = Math.max(this._farPlane, 50)),
      (this._updatePerspectiveMatrix = !0),
  ...
  (Curtains.Plane.prototype._setMVMatrix = function () {
    if (this._updateMVMatrix) {
      ...
      var t = {
        ...
        s = this._curtains._composeMatrixFromOrigin(
          t,
          this.quaternion,
          this.scale,
          i
      ...
      (this._matrices.mvMatrix.matrix = this._curtains._multiplyMatrix(s, r)),
        (this._matrices.mVPMatrix = this._curtains._multiplyMatrix(
          this._matrices.pMatrix.matrix,
  ...
  (Curtains.Plane.prototype.setScale = function (t, e) {
    if (
      ((t = isNaN(t) ? this.scale.x : parseFloat(t)),
      (e = isNaN(e) ? this.scale.y : parseFloat(e)),
      (t = Math.max(t, 0.001)),
      (e = Math.max(e, 0.001)),
      t !== this.scale.x || e !== this.scale.y)
    ) {
      this.scale = { x: t, y: e };
  ...
  (Curtains.Plane.prototype.setRotation = function (t, e, i) {
    (t = isNaN(t) ? this.rotation.x : parseFloat(t)),
      (e = isNaN(e) ? this.rotation.y : parseFloat(e)),
      (i = isNaN(i) ? this.rotation.z : parseFloat(i)),
      (t === this.rotation.x &&
        e === this.rotation.y &&
        i === this.rotation.z) ||
  ...
  (Curtains.Plane.prototype._setQuaternion = function () {
    var t = 0.5 * this.rotation.x,
      e = 0.5 * this.rotation.y,
      i = 0.5 * this.rotation.z,
      s = Math.sin(t),
      r = Math.cos(t),
      a = Math.sin(e),
      n = Math.cos(e),
      o = Math.sin(i),
      h = Math.cos(i);
    (this.quaternion[0] = s * n * h + r * a * o),
      (this.quaternion[1] = r * a * h - s * n * o),
      (this.quaternion[2] = r * n * o + s * a * h),
      (this.quaternion[3] = r * n * h - s * a * o);
  }),
  (Curtains.Plane.prototype.setTransformOrigin = function (t, e, i) {
    (t = isNaN(t) ? this.transformOrigin.x : parseFloat(t)),
      (e = isNaN(e) ? this.transformOrigin.y : parseFloat(e)),
      (i = isNaN(i) ? this.transformOrigin.z : parseFloat(i)),
      (t === this.transformOrigin.x &&
        e === this.transformOrigin.y &&
        i === this.transformOrigin.z) ||
        ((this.transformOrigin = { x: t, y: e, z: i }),
        (this._updateMVMatrix = !0));
  }),
  (Curtains.Plane.prototype._setTranslation = function () {
    ...
    (0 === this.relativeTranslation.x &&
      ...
      0 === this.relativeTranslation.z) ||
      (t = this._documentToLocalSpace(
        this.relativeTranslation.x,
        this.relativeTranslation.y
      )),
      (this._translation.x = this._boundingRect.world.left + t.x),
      (this._translation.y = this._boundingRect.world.top + t.y),
      (this._updateMVMatrix = !0);
  }),
  (Curtains.Plane.prototype.setRelativePosition = function (t, e, i) {
    (t = isNaN(t) ? this.relativeTranslation.x : parseFloat(t)),
      (e = isNaN(e) ? this.relativeTranslation.y : parseFloat(e)),
      (i = isNaN(i) ? this.relativeTranslation.z : parseFloat(i)),
      (t === this.relativeTranslation.x &&
        e === this.relativeTranslation.y &&
        i === this.relativeTranslation.z) ||
        ((this.relativeTranslation = { x: t, y: e, z: i }),
        this._setTranslation());
  }),
  (Curtains.Plane.prototype._documentToLocalSpace = function (t, e) {
    return {
      x:
        (t / (this._curtains._boundingRect.width / this._curtains.pixelRatio)) *
        (this._curtains._boundingRect.width /
          this._curtains._boundingRect.height),
  ...
  (Curtains.Plane.prototype._shouldDrawCheck = function () {
    var t = this._getWebGLDrawRect(),
      e = this;
    Math.round(t.right) <= this._curtains._boundingRect.left ||
    Math.round(t.left) >=
      this._curtains._boundingRect.left + this._curtains._boundingRect.width ||
    Math.round(t.bottom) <= this._curtains._boundingRect.top ||
    Math.round(t.top) >=
      this._curtains._boundingRect.top + this._curtains._boundingRect.height
      ? this._shouldDraw &&
        ((this._shouldDraw = !1),
        setTimeout(function () {
  ...
  (Curtains.Plane.prototype.updateScrollPosition = function () {
    (this._curtains._scrollManager.lastXDelta ||
      this._curtains._scrollManager.lastYDelta) &&
      ((this._boundingRect.document.top +=
        this._curtains._scrollManager.lastYDelta * this._curtains.pixelRatio),
      (this._boundingRect.document.left +=
        this._curtains._scrollManager.lastXDelta * this._curtains.pixelRatio),
      this._applyWorldPositions());
  }),
  ...
  (Curtains.Plane.prototype.moveToFront = function () {
    ...
    for (
      var t = this._transparent ? "transparent" : "opaque",
        e =
          this._curtains._drawStacks[t].programs[
            "program-" + this._usedProgram.id
          ],
        i = 0;
      i < e.length;
      i++
    )
      this.index === e[i] && e.splice(i, 1);
    "transparent" === t ? e.unshift(this.index) : e.push(this.index),
      (this._curtains._drawStacks[t].programs[
        "program-" + this._usedProgram.id
      ] = e);
    for (i = 0; i < this._curtains._drawStacks[t].order.length; i++)
      this._curtains._drawStacks[t].order[i] === this._usedProgram.id &&
        this._curtains._drawStacks[t].order.splice(i, 1);
  ...
  (Curtains.RenderTarget = function (t, e) {
    e || (e = {}),
      ...
      (this._shaderPass = e.shaderPass || null),
      (this._depth = e.depth || !1),
      (this._shouldClear = e.clear),
      (null !== this._shouldClear && void 0 !== this._shouldClear) ||
        (this._shouldClear = !0),
      (this._minSize = {
  ...
  (Curtains.RenderTarget.prototype.resize = function () {
    this._shaderPass &&
      this._shaderPass._isScenePass &&
      (this._setSize(),
      this._curtains._bindFrameBuffer(this, !0),
  ...
  (Curtains.RenderTarget.prototype._bindDepthBuffer = function () {
    var t = this._curtains.gl;
    this._depthBuffer &&
      (t.bindRenderbuffer(t.RENDERBUFFER, this._depthBuffer),
  ...
  (Curtains.RenderTarget.prototype._createFBOTexture = function () {
    ...
    if (this.textures.length > 0)
      (this.textures[0]._canDraw = !1), this.textures[0]._init();
    else {
  ...
  (Curtains.RenderTarget.prototype._createFrameBuffer = function () {
    ...
    (this._frameBuffer = t.createFramebuffer()),
      ...
      this._depth &&
        ((this._depthBuffer = t.createRenderbuffer()), this._bindDepthBuffer()),
      this._curtains._bindFrameBuffer(null);
  }),
  (Curtains.RenderTarget.prototype._restoreContext = function () {
    (this._shaderPass && this._shaderPass._isScenePass) ||
      ((this._shaderPass = null), this._createFrameBuffer());
  }),
  ...
  (Curtains.ShaderPass = function (t, e) {
    e || (e = {}),
      ...
      (this._isScenePass = !0),
      Curtains.BasePlane.call(this, t, t.container, e),
      (this.index = this._curtains.shaderPasses.length),
      (this._depth = e.depth || !1),
      (this._shouldClear = e.clear),
      (null !== this._shouldClear && void 0 !== this._shouldClear) ||
        (this._shouldClear = !0),
      (this.target = e.renderTarget || null),
      this.target &&
        ((this._isScenePass = !1),
        (this._shouldClear = this.target._shouldClear)),
      this._usedProgram && this._initShaderPassPlane();
  }),
  ...
  (Curtains.Texture = function (t, e) {
    if (
      ((this._parent = t),
      (this._curtains = t._curtains),
      (this.uuid = this._curtains._generateUUID()),
      t._usedProgram || e.isFBOTexture)
    )
      return (
        (this.index = t.textures.length),
        (this._sampler = {
          isActive: !1,
        ...
        (this.scale = { x: 1, y: 1 }),
        (this.userData = {}),
        (this.type = e.isFBOTexture ? "fboTexture" : "empty"),
        (this._canDraw = !1),
        e.fromTexture
          ? ((this._initFromTexture = !0),
            this._parent._usedProgram && this._setTextureUniforms(),
            void this.setFromTexture(e.fromTexture))
          : ((this._initFromTexture = !1), this._init(), this)
      );
    this._curtains.productionMode ||
      console.warn(
  ...
  (Curtains.Texture.prototype._init = function () {
    ...
    if (
      ...
      (this._internalFormat = t.RGBA),
      (this._format = t.RGBA),
      (this._textureType = t.UNSIGNED_BYTE),
      (this._texParameters = !1),
      (this._flipY = !1),
      t.bindTexture(t.TEXTURE_2D, this._sampler.texture),
      this._curtains._glState.flipY &&
      ...
      this._size = {
        ...
        height:
          this._parent._size.height || this._curtains._boundingRect.height,
      };
    "fboTexture" === this.type &&
      (this._curtains._isWebGL2 &&
      this._curtains._extensions.EXT_color_buffer_float
        ? ((this._internalFormat = t.RGBA16F),
          (this._textureType = t.HALF_FLOAT))
        : this._curtains._extensions.OES_texture_half_float &&
          (this._textureType =
            this._curtains._extensions.OES_texture_half_float.HALF_FLOAT_OES),
      t.texImage2D(
        t.TEXTURE_2D,
        0,
        this._internalFormat,
  ...
  (Curtains.Texture.prototype._setTextureUniforms = function () {
    for (var t = 0; t < this._parent._activeTextures.length; t++)
      this._parent._activeTextures[t].name === this._sampler.name &&
        ((this._sampler.isActive = !0),
        (this._sampler.location = this._curtains.gl.getUniformLocation(
          this._parent._usedProgram.program,
          this._sampler.name
        )),
        (this._textureMatrix.location = this._curtains.gl.getUniformLocation(
          this._parent._usedProgram.program,
  ...
  (Curtains.Texture.prototype.setFromTexture = function (t) {
    if (t) {
      if (
        ...
        (this._internalFormat = t._internalFormat),
        (this._format = t._format),
        (this._textureType = t._textureType),
        (this._texParameters = t._texParameters),
      ...
      this._curtains.productionMode ||
        console.warn("Unable to set the texture from texture:", t);
  }),
  (Curtains.Texture.prototype.setSource = function (t) {
    if (this._parent._usedProgram) {
      ...
      var e = this._curtains.gl;
      e.activeTexture(e.TEXTURE0 + this.index),
        e.bindTexture(e.TEXTURE_2D, this._sampler.texture),
        this._curtains.premultipliedAlpha &&
          e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0),
        (this._flipY = !0),
        this._curtains._glState.flipY ||
          ((this._curtains._glState.flipY = this._flipY),
          e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, this._flipY)),
        this.resize(),
        "image" === this.type &&
          (e.texImage2D(
            e.TEXTURE_2D,
      ...
      this._curtains.productionMode ||
        console.warn(
          "Unable to set the texture source because the program is not valid"
        );
  }),
  (Curtains.Texture.prototype._setMipmaps = function () {
    ...
    t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE),
      ...
      this._curtains._isWebGL2 && "image" === this.type
  ...
  (Curtains.Texture.prototype._update = function () {
    ...
    this.source
      ? (t.texImage2D(
        ...
        this._texParameters || this._setMipmaps())
      : t.texImage2D(
          t.TEXTURE_2D,
          0,
          this._internalFormat,
  ...
  (Curtains.Texture.prototype._getSizes = function () {
    var t = this._parent.scale ? this._parent.scale : { x: 1, y: 1 },
    ...
    return (
      n > a
        ? (h = Math.min(0, i - e * (1 / a)))
        : n < a && (o = Math.min(0, e - i * a)),
      {
        parentWidth: e,
        parentHeight: i,
        sourceWidth: s,
  ...
  (Curtains.Texture.prototype.setScale = function (t, e) {
    (t = isNaN(t) ? this.scale.x : parseFloat(t)),
      ...
      (e = Math.max(e, 0.001)),
      (t === this.scale.x && e === this.scale.y) ||
        ((this.scale = { x: t, y: e }), this.resize());
  }),
    ...
    if ("fboTexture" === this.type) {
      ...
      (this._size = {
        ...
        this._originalTexture ||
          (t.bindTexture(
            t.TEXTURE_2D,
            this._parent.textures[0]._sampler.texture
          ),
          t.texImage2D(
            t.TEXTURE_2D,
            0,
  ...
  (Curtains.Texture.prototype._updateTextureMatrix = function (t) {
    ...
    (this._textureMatrix.matrix = this._curtains._scaleMatrix(i, e.x, e.y, 1)),
      this._curtains._useProgram(this._parent._usedProgram),
      this._curtains.gl.uniformMatrix4fv(
      ...
      (this._sourceLoaded ||
        setTimeout(function () {
          e._parent._onPlaneLoadingCallback &&
            e._parent._onPlaneLoadingCallback(e);
        }, 0),
      this.setSource(t),
      this._parent._isPlaneReady(),
      "image" === this.type)
    ) {
      for (var i = !0, s = 0; s < this._curtains._imageCache.length; s++)
        this._curtains._imageCache[s].source &&
          this._curtains._imageCache[s].source.src === t.src &&
          (i = !1);
  ...
  (Curtains.Texture.prototype._drawTexture = function () {
    this._sampler.isActive &&
      ...
      this._flipY &&
        !this._curtains._glState.flipY &&
        ((this._curtains._glState.flipY = this._flipY),
        this._curtains.gl.pixelStorei(
          this._curtains.gl.UNPACK_FLIP_Y_WEBGL,
          this._flipY
        )),
      "video" === this.type &&
        this.source &&
      ...
      (this._forceUpdate || (this._willUpdate && this.shouldUpdate)) &&
        this._update(),
      "video" === this.type && (this._willUpdate = !1),
      (this._forceUpdate = !1));
  }),
  (Curtains.Texture.prototype._restoreFromTexture = function () {
    this._initFromTexture ? this._setTextureUniforms() : this._init(),
    ...
    if (
      ...
      if (this._originalTexture._canDraw)
        ...
        var e = setInterval(function () {
          t._originalTexture._canDraw &&
            (t._restoreFromTexture(), clearInterval(e));
        }, 16);
    } else
      this._init(),
        this.source &&
          ("image" === this.type && this._curtains._imageCache.push(this),
